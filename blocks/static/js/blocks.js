var NumberWidget = function(container, init, min, max) {
    container.classed('number-widget', true)
...
var Pattern = function(thing_id, set_states) {
    this.container = d3.select("#" + thing_id).attr('class', 'pattern');

    var xwidget = new NumberWidget(this.container.append('div')
        .attr('class', 'cols'), 3);
    var ywidget = new NumberWidget(this.container.append('div')
        .attr('class', 'rows'), 3);
    ...
    if (set_states) {
        var num_states = new NumberWidget(this.container.append('div')
            .attr('class', 'states'), 2, 2, 4);
